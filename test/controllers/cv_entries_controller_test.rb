...
class CvEntriesControllerTest < ActionController::TestCase
  ...
  test "should create cv_entry" do
    assert_difference('CvEntry.count') do
      post :create, cv_entry: { company_id: @cv_entry.company_id, end_date: @cv_entry.end_date, start_date: @cv_entry.start_date, user_id: @cv_entry.user_id }
    end
  ...
  test "should update cv_entry" do
    patch :update, id: @cv_entry, cv_entry: { company_id: @cv_entry.company_id, end_date: @cv_entry.end_date, start_date: @cv_entry.start_date, user_id: @cv_entry.user_id }
    assert_redirected_to cv_entry_path(assigns(:cv_entry))
  end
